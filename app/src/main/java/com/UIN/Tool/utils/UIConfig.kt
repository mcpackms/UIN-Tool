        ...
        return try {
            JSONObject().apply {
                put("theme", JSONObject().apply {
                    put("primary", "#FF0D8A7A")
                    put("primary_dark", "#FF075F52")
                    put("primary_light", "#FFD1F2EB")
                    put("accent", "#FFD4890B")
                    put("success", "#FF30A46B")
                    put("warning", "#FFF5A623")
                    put("error", "#FFE5484D")
                    put("info", "#FF3B82F6")
                    put("text_primary", "#FF1A1A1A")
                    put("text_secondary", "#FF6B7280")
                    put("text_hint", "#FFB0B5BC")
                    put("text_primary_inverse", "#FFFFFFFF")
                    put("background", "#FFF5F5F0")
                    put("surface", "#FFFFFFFF")
                    put("surface_variant", "#FFEEEFEC")
                    put("divider", "#FFE2E4E0")
                    put("glass_background", "#E6FFFFFF")
                    put("disabled", "#FFB0B5BC")
                })
                put("shape", JSONObject().apply {
                    put("cornerRadiusSmall", 4)
                    put("cornerRadiusMedium", 4)
                    put("cornerRadiusLarge", 6)
                    put("cornerRadiusExtraLarge", 8)
                    put("buttonCornerRadius", 4)
                    put("cardCornerRadius", 4)
                    put("dialogCornerRadius", 6)
                    put("inputCornerRadius", 4)
                })
                put("size", JSONObject().apply {
                    put("buttonHeight", 42)
                    put("buttonMinWidth", 72)
                    put("buttonElevation", 0)
                    put("cardElevation", 0)
                    put("cardPadding", 12)
                    put("spacingSmall", 4)
                    put("spacingMedium", 8)
                    ...
                    put("progressHeight", 3)
                    put("titleTextSize", 18)
                    put("bodyTextSize", 13)
                    put("captionTextSize", 11)
                    put("sectionTitleTextSize", 14)
                })
