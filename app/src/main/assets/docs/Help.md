...
应用内更新检查功能，支持从 GitHub Releases 检测和下载最新版本。
...
```
/storage/emulated/0/UIN_Tool/downloads/UIN_Tool_v{版本号}.apk
```
...
· 方式一：在「管理」→「检查更新」中下载安装
· 方式二：从 GitHub Releases 下载 APK 安装
...
版本 更新内容
v3.0.0 新增 SplashActivity 启动页、OnboardingActivity 引导页、文档中心、权限说明页面、点状指示器；优化白屏问题；修复多个稳定性问题
v2.8.0 新增应用内更新检查、版本列表、应用内下载、后台下载、通知栏提醒
v2.6.0 新增 Web 插件网络请求 API、文件系统 API、传感器 API；完善搜索功能；优化插件加载稳定性
