...
├── web_plugin_template/          # Web 插件模板目录
│   ├── index.html
│   ├── style.css
│   ├── script.js
│   └── blank_index.html
